    ...
    var GAME_DATA = window.SKACHKI_DATA || {};
    var stableNames = GAME_DATA.stableNames || ['Буран', 'Молния', 'Ветерок'];
    var temperaments = GAME_DATA.temperaments || ['Смелая', 'Пугливая', 'Упрямая', 'Резкая', 'Быстрая'];
    var trainingTypes = GAME_DATA.trainingTypes || [];
...
*/
(function () {
  var CONSOLIDATED_DATA = window.SKACHKI_DATA || {};
  var RACE_TYPES = CONSOLIDATED_DATA.raceTypes || [];
  var BOT_NAMES = CONSOLIDATED_DATA.botNames || [];
  var HELP = CONSOLIDATED_DATA.parameterHelp || {};
